...
interface ReservaRepository : JpaRepository<Reserva, Long> {
    ...
    @Query("""
        ...
        AND r.estado = 'CONFIRMADA'
        AND r.fechaHora >= :inicioSemana 
        AND r.fechaHora < :finSemana
    """)
    fun countReservasSemana(
        usuarioId: Long,
        inicioSemana: LocalDateTime,
        finSemana: LocalDateTime
    ): Long
}